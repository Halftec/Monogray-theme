...
//
// Pins live in this widget's shell.json entry:
...
BarWidget {
  ...
  readonly property var pinnedIds: root.setting("pinned", root.defaultPins)
      ...
      Item {
        ...
        MouseArea {
          ...
          onClicked: function(event) {
            ...
            else if (event.button === Qt.RightButton) root.launch(tile.modelData)
